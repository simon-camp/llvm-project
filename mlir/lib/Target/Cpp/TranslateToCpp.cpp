...
struct CppEmitter {
  ...
  /// Whether the C/C++ representation of the type is copy assignable.
  /// Assignments are used when the option declareVariablesAtTop is set. This is
  /// needed in the translation of func.func with multiple blocks.
  /// TODO: Move this into a verifier pass.
...
bool CppEmitter::isCopyAssignable(Type type) {
  // TODO: Remove special handling of the TensorType from the emitter.
