...
// CHECK-NEXT:    %[[VAL_5:.*]] = emitc.variable noinit : f32
// CHECK-NEXT:    %[[VAL_6:.*]] = emitc.variable noinit : f32
// CHECK-NEXT:    %[[VAL_7:.*]] = emitc.variable noinit : f32
// CHECK-NEXT:    %[[VAL_8:.*]] = emitc.variable noinit : f32
...
// CHECK-NEXT:    %[[VAL_4:.*]] = emitc.variable noinit : f32
// CHECK-NEXT:    %[[VAL_5:.*]] = emitc.variable noinit : f32
