...
func.func @cmp(%arg0 : i32, %arg1 : f32, %arg2 : i64, %arg3 : f64, %arg4 : !emitc.opaque<"unsigned">, %arg5 : !emitc.opaque<"std::valarray<int>">) {
...
// CHECK-NEXT:  bool [[V6:[^ ]*]] = [[V0:[^ ]*]] == [[V0:[^ ]*]]
// CHECK-NEXT:  bool [[V7:[^ ]*]] = [[V1:[^ ]*]] != [[V1:[^ ]*]]
// CHECK-NEXT:  bool [[V8:[^ ]*]] = [[V2:[^ ]*]] < [[V2:[^ ]*]]
// CHECK-NEXT:  bool [[V9:[^ ]*]] = [[V3:[^ ]*]] <= [[V3:[^ ]*]]
// CHECK-NEXT:  bool [[V10:[^ ]*]] = [[V4:[^ ]*]] > [[V4:[^ ]*]]
// CHECK-NEXT:  std::valarray<bool> [[V11:[^ ]*]] = [[V5:[^ ]*]] >= [[V5:[^ ]*]]
